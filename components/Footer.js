...
function Footer() {
  return (
    <footer className="grid w-full divide-y-[1px] divide-gray-300 bg-gray-200 text-sm text-gray-500">
      ...
      <div className="grid grid-cols-1 md:grid-col-2 lg:grid-cols-3 gap-y-4 grid-flow-row-dense py-2 px-8">
        <div className="flex justify-center items-center md:col-span-2 lg:col-span-1 lg:col-start-2">
          <GlobeIcon className="h-5 mr-1 text-green-700" /> How Search Works
        </div>
